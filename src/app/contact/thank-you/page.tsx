      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-4xl text-center">
        ...
        <div className="mb-12 inline-flex justify-center relative">
          <div className="w-32 h-32 md:w-40 md:h-40 bg-brand-secondary rounded-full border border-border shadow-md flex items-center justify-center z-10 animate-bounce">
            <CheckCircle2 className="w-20 h-20 md:w-24 md:h-24 text-foreground" strokeWidth={3} />
          </div>
        ...
        <h1 className="text-5xl md:text-8xl font-black text-foreground tracking-tight uppercase leading-[1.1] mb-6">
          Request <span className="bg-brand-mint px-4 py-2 inline-block border border-border shadow-md -rotate-2">Received</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-3xl mx-auto mb-16 text-left">
          <div className="bg-surface p-8 rounded-[2rem] border border-border shadow-md hover:-translate-y-2 hover:shadow-md transition-transform">
            ...
            <h3 className="text-2xl font-black text-foreground uppercase mb-3">Strategy Review</h3>
            <p className="text-lg font-bold text-muted">Our team is currently analyzing your request, your industry, and the exact tools needed to scale your operation.</p>
          </div>
          <div className="bg-surface p-8 rounded-[2rem] border border-border shadow-md hover:-translate-y-2 hover:shadow-md transition-transform">
            ...
            <h3 className="text-2xl font-black text-foreground uppercase mb-3">Prepare to Scale</h3>
            <p className="text-lg font-bold text-muted">If there is a fit, we will schedule a ruthless, no-fluff discovery call to map out your growth strategy.</p>
          </div>
        </div>

        {/* DIRECT CONTACT OPTIONS */}
        <div className="max-w-3xl mx-auto mb-16 bg-brand-primary rounded-[2rem] border border-border p-8 md:p-12 shadow-md text-center relative overflow-hidden">
          <div className="relative z-10">
            <h3 className="text-3xl font-black text-foreground uppercase mb-4">Too Urgent to Wait?</h3>
