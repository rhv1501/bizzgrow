...
import { buildFaqSchema, toJsonLd } from "../utils/seo";

const items = [
  {
    q: "How long does a typical project take?",
    a: "A full project, including brand strategy, web design, and setup work, usually takes 6 to 10 weeks. Smaller jobs like landing pages or updates often take 2 to 4 weeks.",
    brandColor: "bg-brand-mint/40",
    borderColor: "border-brand-mint/60",
  },
  {
    q: "Do you handle both strategy and execution?",
    a: "Yes. We handle the planning and the build. From the first discovery call to the final launch, we can take the work all the way through.",
    brandColor: "bg-brand-peach/40",
    borderColor: "border-brand-peach/60",
  },
  {
    q: "Can you integrate with our existing software stack?",
    a: "Absolutely. We can connect with the tools you already use, whether that is Shopify, HubSpot, Salesforce, or custom systems.",
...
const Faq = () => {
  ...
  return (
    <section className="py-24 md:py-32 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-200 h-200 bg-brand-peach/10 rounded-full blur-[120px] pointer-events-none -z-10 translate-x-1/3 -translate-y-1/3" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-32">
            <motion.h2
              ...
              className="text-[clamp(3.5rem,6vw,5.5rem)] font-black tracking-tight text-foreground leading-none"
            >
              FAQ.
            </motion.h2>
            <motion.p
            ...
            >
              Frequent inquiries.
              <br />
              Clarity is essential before any engagement. Here is how we
              operate.
            </motion.p>
          </div>
                ...
                <motion.div
                  ...
                  animate={{
                    backgroundColor: isOpen
                      ? "var(--tw-bg-opacity, 1)"
                      : "rgba(255, 253, 249, 0)", // transparent or filled
                  }}
