...
export const metadata: Metadata = {
  title: "Careers | Join BizzGrowLabs",
  description:
    "Join BizzGrowLabs and help build premium digital experiences and growth systems for ambitious businesses.",
  alternates: {
...
const perks = [
  {
    ...
    title: "Hybrid Work",
    description:
      "The best of both worlds. Collaborate in person when it matters, and focus from home when you need to.",
    color: "bg-[#FF9E80]",
  },
  {
    icon: Target,
    ...
    description:
      "We hate red tape. You will have the autonomy to make decisions and ship fast.",
    color: "bg-brand-mint",
  },
  {
    icon: Users,
    ...
    description:
      "You'll be working alongside people who are unreasonably good at what they do.",
  ...
  },
  {
    ...
    description:
      "You aren't just a cog in a machine. The work you do here directly scales businesses.",
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-7xl">
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-foreground mb-6 md:mb-8 tracking-tight leading-[1.1] uppercase">
            Stop Doing{" "}
            <span className="bg-brand-accent px-4 py-1 inline-block border border-border shadow-md md:shadow-md rotate-2">
              Boring Work.
            </span>
          </h1>

          <p className="text-xl md:text-2xl font-bold text-muted max-w-2xl mx-auto leading-relaxed">
            We are looking for aggressive problem solvers, creative
            rule-breakers, and people who are obsessed with quality.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {perks.map((perk, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`${perk.color} p-8 rounded-4xl border border-border shadow-md hover:-translate-y-2 hover:shadow-md transition-all duration-300`}
                >
        ...
        <section className="bg-background rounded-4xl md:rounded-[3rem] p-8 md:p-16 border border-border shadow-md text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-xl md:text-2xl font-bold text-muted mb-10 leading-relaxed">
              We don&apos;t post specific open roles because we are always
              looking for exceptional talent. If you are unreasonably good at
              what you do, we want to hear from you.
            </p>
            <Link
              href="/contact"
              className="btn-primary text-xl px-12 py-5 inline-flex items-center shadow-md hover:shadow-md hover:-translate-y-1 transition-all"
            >
