  ...
  return (
    ...
    >
      <div className={`lg:col-span-7 ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
        <Link href={`/project/${project.slug}`} className="block relative rounded-[2rem] md:rounded-[3rem] overflow-hidden aspect-video bg-surface border border-border/60 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] transform transition-transform duration-[800ms] ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-[1.02]">
