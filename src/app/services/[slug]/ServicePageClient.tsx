...
import { ArrowLeft, ArrowRight, CheckCircle, Sparkles, Layers } from "lucide-react";
  ...
  return (
    <main className="pt-32 pb-16 md:pb-32 relative bg-background overflow-hidden selection:bg-brand-primary selection:text-background">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[120%] h-[600px] bg-brand-primary/5 blur-[150px] mix-blend-normal" />
      </div>
        ...
        <section className="mb-24 lg:mb-32">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h1 className="text-[clamp(3.5rem,6vw,7rem)] font-black text-foreground tracking-tighter leading-[0.9] uppercase break-words">
                {service.title}
              </h1>
              
              <p className="text-2xl md:text-3xl font-medium text-foreground leading-[1.2] tracking-tight max-w-2xl">
                {service.headline}
              </p>
            ...
            >
              <div 
                className="relative w-full aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-surface shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] border border-border/40 group cursor-crosshair flex items-center justify-center"
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-24 lg:mb-40">
          ...
          <div className="lg:col-span-7 space-y-24">
            ...
            >
              ...
              <h3 className="text-3xl md:text-5xl font-black text-foreground mb-12 tracking-tighter uppercase leading-[1]">
                How this transforms <br/> <span className="italic font-serif text-brand-primary">your business.</span>
              </h3>
            ...
            >
              ...
              <h3 className="text-3xl md:text-5xl font-black text-foreground mb-12 tracking-tighter uppercase leading-[1]">
                How we keep <br/> everything <span className="italic font-serif text-brand-primary">aligned.</span>
              </h3>
              <ul className="space-y-8">
            ...
            >
              ...
              <div className="w-full border-t border-border/40">
                {service.subServices.map((sub: { name: string; description: string; keywords: string[] }, idx: number) => {
                  ...
                  return (
                    ...
                    >
                      <button 
                        onClick={() => setActiveArsenal(isActive ? null : idx)}
                      ...
                      >
                        <h3 className={`text-[clamp(1.5rem,3vw,3rem)] font-medium tracking-tight uppercase transition-all duration-500 origin-left ${isActive ? "text-brand-primary italic font-serif scale-105" : "text-foreground group-hover:translate-x-4"}`}>
                          {sub.name}
                        </h3>
                        <div className="flex items-center gap-6">
                           ...
                           <div className={`w-12 h-12 rounded-full border flex items-center justify-center transition-all duration-500 ${isActive ? "border-brand-primary bg-brand-primary text-background rotate-45" : "border-border/40 text-foreground group-hover:border-foreground"}`}>
          ...
          <aside className="lg:col-span-5 space-y-12">
            ...
            >
              <h2 className="text-sm font-mono uppercase tracking-widest text-muted mb-8">Process</h2>
              <h3 className="text-3xl font-black text-foreground mb-8 uppercase tracking-tight">How we deliver</h3>
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-4 p-4 rounded-xl hover:bg-background transition-colors duration-300">
                     <span className="text-xs font-mono text-muted pt-1 shrink-0">0{idx+1}</span>
            ...
            <motion.div 
              ...
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 0.8 }}
              className="bg-brand-mint rounded-[2rem] p-10 text-foreground border border-border/40 shadow-sm"
            >
              <h2 className="text-sm font-mono uppercase tracking-widest text-foreground/60 mb-8">Methodology</h2>
              <h3 className="text-3xl font-black mb-10 uppercase tracking-tight text-foreground">How it works</h3>
              <ol className="space-y-8">
                {service.howItWorks.map((step: string, idx: number) => (
                  <li key={idx} className="flex items-start gap-5 relative group">
                    ...
                    <span className="text-lg font-medium mt-1 leading-snug text-foreground">{step}</span>
                  </li>
                ))}
              </ol>
            </motion.div>
          ...
          >
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl font-medium text-foreground/80 mb-12 max-w-2xl mx-auto leading-relaxed">
                Let&apos;s build an ecosystem that forces your market to pay attention. No templates, no fluff.
              </p>
